        ...
        <div className="flex items-center gap-2 h-full cursor-pointer" onClick={onOpenInfo}>
          {!logoError && logoUrl ? (
            ...
            <div className="flex items-center gap-2 animate-in fade-in">
               ...
               <div>
                  <h1 className="font-display text-xl sm:text-2xl leading-none">{storeName.split(' ')[0]}</h1>
                  <p className="text-[10px] sm:text-xs text-italian-white font-light tracking-wider">PIZZARIA</p>
               </div>
            </div>
          )}
        </div>
